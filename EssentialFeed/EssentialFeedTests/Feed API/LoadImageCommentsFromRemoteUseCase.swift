...
class LoadImageCommentsFromRemoteUseCaseTests: XCTestCase {
	...
	func test_load_deliversFeedItemsOn2xxHTTPResponseWithJSONItems() {
		let (sut, client) = makeSUT()
		...
		let item2 = makeItem(
			...
			createdAt: (Date(timeIntervalSince1970: 1598627223), "2020-08-28T15:07:03+00:00"),
	...
	func test_load_doesNotDeliverResultAfterSUTInstanceHasBeenDeallocated() {
		...
		// here we test that after the RemoteImageCommentsLoader has been deallocated, the client does not execute any completion, as this might be an unexpected behaviour
