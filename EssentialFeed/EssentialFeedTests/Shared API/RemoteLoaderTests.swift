...
//  EssentialFeedTests
//
//  Created by Antonio Epifani on 12/06/23.
//
...
final class RemoteLoaderTests: XCTestCase {
	...
	func test_load_doesNotDeliverResultAfterSUTInstanceHasBeenDeallocated() {
		...
		// here we test that after the RemoteLoader<String> has been deallocated, the client does not execute any completion, as this might be an unexpected behaviour
